		...
		carouselle: [
			{
				...
				header: "Resepsjon",
				info:
					"De som er på kontor har ansvar for resepsjonen, her tar du telefoner, sier god morgen til de som kommer og har oversikt over oppmøte og registreringer",
			},

			{
				...
				header: "Slette filer",
				info:
					"En gang i uken går man igjennom nedlastede filer og sletter dem. Det er viktig for å holde orden i systemene",
			},

			{
				...
				header: "Reach out",
				info:
					"De som vil kan sette seg opp til Reach out. Det vil si at hvis du har vært borte en stund fra huset tar vi kontakt med deg for å høre hvordan du har det.",
			},

			{
				...
				header: "Bursdagskort",
				info:
					"Alle på huset har bursdag en eller annen gang. Huset ønsker å vise at vi setter pris på medlemmene og ønske de en god bursdag",
			},

			{
				...
				info:
					"Den som leder tavlemøte går igjennom dagens oppgaver og setter opp hvem som gjør hva utfra ønsker til de som er på møte.",
			},

			{
				...
				header: "Makulering",
				info:
					"Papirer som inneholder sensitiv informasjon og som man ikke skal bruke lenger må makuleres.",
			},
		],
	},
		...
		carouselle: [
			{
				...
				header: "Magasin",
				info:
					"Magasinet blir jobbet med på mandager fremover. Vi prøver å finne saker som er interessante og relevante for både huset og andre utenfor. Layout blir laget i InDesign, og vi er veldig stolt over de utgavene vi har laget så langt",
			},

			{
				...
				header: "Podcast",
				info:
					"Podcasten blir jobbet med på tirsdager fremover. Her skal vi både planlegge for å finne gjester og tema, men også prøve oss frem, bli kjent med utstyr og teknikk på et ufarlig nivå",
			},

			{
				...
				info:
					"Onsdager er ryddedag. På vår felles filserver er det et enormt hav av bilder og filer. Det håper vi å få litt orden på etterhvert",
			},

			{
				...
				header: "Programvare",
				info:
					"Torsdag er en dag hvor vi jobber med forskjellige typer programvare, alt fra Photoshop til PowerPoint. Hvis vi klarer det så er målet at vi kan lage noen kurs som vi kan holde for resten av huset. Det er likvel lov å prøve seg frem på et lavt nivå, uten krav om å produsere noe.",
			},

			{
				...
				info:
					"Media skal fronte Fontenehuset utad gjennom sosiale medier. På fredager setter vi oss ned og planlegger sosiale medier for uken som kommer, hvilke ting på huset skal vi dekke?",
			},

			{
				...
				header: "Ny avdeling",
				info:
					"Media skal flytte etasje fra 3. til 2. etasje. Vi trenger derfor å tenke ut hvordan vi ønsker at avdelingen skal bli og lage en plan for det",
			},
		],
	},
...
export const CafeData = [
	{
		...
		meny: [
...

			{
				...
				beskrivelse:
					"Svært aromatiske med fløyelsaktige og søte smaker, mild bitterhet og subtil syrlighet.",
			},

			{
				...
				beskrivelse:
					"Balansert, myk og kremet smak uten å være bitter. Du vil også oppleve at kaffen har en behagelig ettersmak av brent hasselnøtt og brunt sukker",
			},
		],
